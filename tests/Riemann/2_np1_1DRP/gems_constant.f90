module gems_constant
   ...
   integer, parameter :: nmeq = 1   ! - number of momentum eq
   ...
   real(rfp), parameter    :: four     = 4.0_rfp
   ...
   real(rfp), parameter :: sqrt3 = 1.732050807_rfp

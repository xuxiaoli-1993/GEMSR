...
contains
   ...
   subroutine inlet_user_define(cf, bc)
      ...
      real(rfp) :: r, theta0, U0, Uc, R0, T0, sos, x0, yc, xc
      ...
      !   qvr % v = (/0.029d0, 1.206d0, 1.206d0, 0.00732960839d0/)
      !else if(xc > 0.5 .and. yc <= 0.5) then
      !   qvr % v = (/0.3d0, 0.0d0, 1.206d0, 0.00196574259d0/)
      !else if(xc > 0.5 .and. yc > 0.5) then
      !   qvr % v = (/1.5d0, 0.0d0, 0.0d0, 0.00348788261d0/)
      !else
      !   qvr % v = (/0.3d0, 1.206d0, 0.0d0, 0.00196574259d0/)
      !end if

MODULE dfd_type
    ...
    type cell
        ...
        real(kind = rfp) :: srf, srfm, rp, er ! max spectral radius flux (c*area)
        ...
        real(kind = rfp) :: curvature, Vinterface, vinterface2
    ...
    type face
        ...
        real(rfp), pointer :: avec(:,:) ! normal vector on the nodes 
    end type face

MODULE dfd_constant
    ...
    integer, parameter :: ils = nceq + nmeq + neeq + nteq + naux + nspm1 + nrad + 1 ! - the begin number of auxiliary equation
    !
    integer, parameter :: ibb = ils + nls ! the begin number of b equ.
